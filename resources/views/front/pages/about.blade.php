            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="inner-header heading1">
                        ...
                        <p><a href="/">Home</a> <svg xmlns="http://www.w3.org/2000/svg" width="9"
                    ...
                    <div class="heading1">
                        ...
                        <div class="perag-bg">
                            ...
                            <div class="btn-area1" data-aos="fade-up" data-aos-duration="1000">
                                <a href="property-details-v1.html" class="vl-btn1">See Properties <span class="arrow1"><i
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="mission-heading heading1">
                        ...
                        <div class="space16"></div>
                        <p>We are committed to providing expert guidance, cutting-edge technology, and personalized
                            solutions that empower to clients make confident real estate decisions. Whether you’re searching
                            for your dream home maximizing value of your property, we strive to deliver excellence, trust,
                            and innovation at every step of the journey.</p>
                        <div class="space32"></div>
                        <h3>Our Mission</h3>
                        <div class="space16"></div>
                        <p>To simplify real estate transactions through innovation, transparency, and expert guidance,
                            ensuring every client finds their dream property with ease.</p>
                        <div class="space32"></div>
                        <h3>Our Vision</h3>
                        <div class="space16"></div>
                        <p>To be the most trusted and innovative real estate platform, transforming the way people buy,
                            sell, and invest in properties.</p>
                        <div class="space32"></div>
                        <div class="btn-area1">
                            <a href="property-details-v1.html" class="vl-btn1">See All Properties <span class="arrow1"><i
                                        class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i
                                        class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="choose-heading heading1">
                        ...
                        <div class="space16"></div>
                        <p>Choosing Housa means partnering with a real estate company that puts your needs first. We combine
                            industry expertise, innovative technology, and a client-centric approach to simplify property
                            transactions.</p>
                        <div class="space24"></div>
                        <div class="choose-box">
                            <a href="our-service.html">Expert Guidance</a>
                            <div class="space16"></div>
                            <p>Our team of real estate professionals is dedicated to providing the best market insights and
                                tailored advice.</p>
                        </div>
                        <div class="space24"></div>
                        <div class="choose-box">
                            ...
                            <div class="space16"></div>
                            <p>From modern apartments to luxury villas, we offer diverse listings to match your preferences.
                            </p>
                        </div>
                        <div class="space24"></div>
                        <div class="choose-box">
                        ...
                        <div class="space32"></div>
                        <div class="btn-area1">
                            <a href="contact.html" class="vl-btn1">Contact Us <span class="arrow1"><i
                                        class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i
                                        class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                        ...
                        <ul class="nav nav-pills" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                    ...
                                    aria-controls="pills-home" aria-selected="true"><svg
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-contact3-tab" data-bs-toggle="pill"
                                    ...
                                    aria-controls="pills-contact3" aria-selected="false"><svg
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                        <path
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="property-single-boxarea">
                                            <div class="property-list-img-area owl-carousel">
                                                ...
                                                <a href="property-details-v1.html">
                                                    <div class="img1 image-anime">
                                                        <img src="/assets/img/all-images/properties/property-img2.png"
                                                            alt="housa">
                                                    </div>
                                                </a>
                                                <a href="property-details-v1.html">
                                                    <div class="img1 image-anime">
                                                        <img src="/assets/img/all-images/properties/property-img3.png"
                                                            alt="housa">
                                                    </div>
                                                </a>
                                            </div>
                                            ...
                                            <div class="property-price">
                                                <div class="text">
                                                    <a href="property-details-v1.html" class="title">Golden Oaks
                                                        Residence</a>
                                                    <div class="space16"></div>
                                            ...
                                            <div class="btn-area1 text-center">
                                                <a href="property-details-v1.html" class="vl-btn1">View Property Details
                                                    <span class="arrow1"><i
                                        ...
                                        <div class="property-single-boxarea">
                                            ...
                                            <div class="property-other-widget">
                                                ...
                                                <div class="btn-area">
                                                    <div class="name-area">
                                                        <div class="img">
                                                            <img src="/assets/img/all-images/others/others-img2.png"
                                                                alt="housa">
                                                        </div>
                                                        <div class="text">
                                                            <a href="#">John Dukes</a>
                                        ...
                                        <div class="property-single-boxarea">
                                            ...
                                            <div class="property-other-widget">
                                                ...
                                                <div class="btn-area">
                                                    <div class="name-area">
                                                        <div class="img">
                                                            <img src="/assets/img/all-images/others/others-img3.png"
                                                                alt="housa">
                                                        </div>
                                                        <div class="text">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="property-single-boxarea">
                                            <div class="property-list-img-area owl-carousel">
                                                <a href="property-details-v1.html">
                                                    <div class="img1 image-anime">
                                                        <img src="/assets/img/all-images/properties/property-img4.png"
                                                            alt="housa">
                                                    </div>
                                                </a>
                                                <a href="property-details-v1.html">
                                                    <div class="img1 image-anime">
                                                        <img src="/assets/img/all-images/properties/property-img5.png"
                                                            alt="housa">
                                                    </div>
                                                </a>
                                                <a href="property-details-v1.html">
                                                    <div class="img1 image-anime">
                                                        <img src="/assets/img/all-images/properties/property-img6.png"
                                                            alt="housa">
                                                    </div>
                                                </a>
                                            </div>
                                        ...
                                        <div class="property-single-boxarea">
                                            ...
                                            <div class="property-other-widget">
                                                ...
                                                <div class="btn-area">
                                                    <div class="name-area">
                                                        <div class="img">
                                                            <img src="/assets/img/all-images/others/others-img5.png"
                                                                alt="housa">
                                                        </div>
                                                        <div class="text">
                                        ...
                                        <div class="property-single-boxarea">
                                            ...
                                            <div class="property-other-widget">
                                                ...
                                                <div class="btn-area">
                                                    <div class="name-area">
                                                        <div class="img">
                                                            <img src="/assets/img/all-images/others/others-img6.png"
                                                                alt="housa">
                                                        </div>
                                                        <div class="text">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-6">
                                        <div class="property-single-boxarea">
                                            ...
                                            <div class="btn-area1 text-center">
                                                <a href="#" class="vl-btn1">View Property Details <span
                                                        class="arrow1"><i
                                                            class="fa-solid fa-arrow-right"></i></span><span
                                                        class="arrow2"><i
                                                            class="fa-solid fa-arrow-right"></i></span></a>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="property-single-boxarea">
                                            ...
                                            <div class="btn-area1 text-center">
                                                <a href="my-property.html" class="vl-btn1">View Property Details <span
                                                        class="arrow1"><i
                                                            class="fa-solid fa-arrow-right"></i></span><span
                                                        class="arrow2"><i
                                                            class="fa-solid fa-arrow-right"></i></span></a>
