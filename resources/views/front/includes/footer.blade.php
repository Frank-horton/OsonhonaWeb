                ...
                <div class="row">
                    <div class="col-lg-10 m-auto">
                        <div class="heading1 text-center">
                            <h2 class="text-anime-style-3">Давайте воплотим ваши мечты о недвижимости в реальность</h2>
                            <div class="space16"></div>
                            {{-- <p data-aos="fade-up" data-aos-duration="900">Не ждите, чтобы начать свой путь в сфере
                                недвижимости. Покупаете ли вы, продаете или арендуете, наша
                                команда экспертов здесь, чтобы сопровождать вас на каждом этапе пути. Давайте превратим
                                ваше видение в реальность с помощью
                                персонализированного обслуживания и безупречного опыта.</p> --}}
                            <div class="space32"></div>
                            <div class="btn-area1" data-aos="fade-up" data-aos-duration="1000">
                                <a href="/search_grid" class="vl-btn1">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-time-area">
                            <img src="/assets/icons/logo.svg" alt="housa" style="object-fit: cover!important">
                            <div class="space24"></div>
                            <p>Мы стремимся сделать ваш путь в сфере недвижимости гладким и беззаботным. Независимо от
                                того, покупаете ли вы, продаете или арендуете, на каждом этапе пути.</p>
                        </div>
                    </div>
                    {{-- <div class="col-lg col-md-6">
                        ...
                        <div class="footer-widget-area foot-padding1">
                            ...
                            <ul>
                                ...
                                <li><a href="/properties">Неддвижимости</a></li>
                    ...
                    <div class="col-lg-4 col-md-4">
                        ...
                        <div class="footer-widget-area">
                            ...
                            <ul>
                                <li>
                                    <a href="tel:+11234567890"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                ...
                                <li>
                                    <a href="mailto:osongroup@gmail.com">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none">
                                            <path
                    ...
                    <div class="col-lg-4 col-md-4">
                        ...
                        <div class="footer-widget-area">
                            ...
                            <ul>
                                <li>
                                    <a
                                        href="https://www.instagram.com/osonhona.tj?igsh=MXF0MDZhZDRremRsZA%3D%3D&utm_source=qr">
                ...
                <div class="col-lg-12">
                    <div class="copyright-area">
                        <p>© 2025 Osongroup, Inc. All Rights Reserved.</p>
                        <ul>
                            <li><a href="#">Политика конфиденциальности</a><span> | </span></li>
