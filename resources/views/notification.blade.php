        ...
        <div class="card-header">
            <div class="page-title w-100">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <button type="button" class="btn theme-bg theme-btn text-white" data-bs-toggle="modal" data-bs-target="#notificationModal">
                        {{ __('addNotification') }}
                    </button>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <form id="addNotificationForm" method="post">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn theme-btn text-white saveButton"> {{ __('send') }}</button>
                </div>
            </form>
        </div>
    </div>
